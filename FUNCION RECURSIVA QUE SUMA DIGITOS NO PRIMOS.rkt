...
;NO primos de un numero

;E--> n(numero que digita el usuario)
;P--> el digito que no sea primo se suma con los otros digitos no primos
;S--> la suma de los digitos primos es

(define (primo n)
  (if (not (or (= n 1) (= n 2) (= n 3) (= n 5) (= n 7)))
      n
      0
      ))
...
(define (interfaz n)
  ...
  (set! n (read))
  (display "la suma de los digitos no primos es igual a= ")
  (sumaprimos n)
  )
